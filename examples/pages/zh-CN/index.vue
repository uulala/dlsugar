  ...
  <div>
    <div class="banner">
      <div class="banner-desc">
        <h1>网站快速成型工具</h1>
        <p>Dlsugar，一套为开发者、设计师和产品经理准备的基于 Vue 2.0 的桌面端组件库</p>
      </div>
    </div>
    ...
    <div class="sponsors">
      <a class="sponsor" href="https://tipe.io/?ref=dlsugar" target="_blank" v-show="lang !== 'zh-CN'">
      ...
      <!-- <a class="sponsor" href="https://www.duohui.cn/?utm_source=dlsugar&utm_medium=web&utm_campaign=dlsugar-index" target="_blank"> -->
...
import { addClass, removeClass } from 'dlsugar-ui/src/utils/dom'
